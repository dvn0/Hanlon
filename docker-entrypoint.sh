...
then
  ...
  then
    ...
    ./hanlon_init -j '{"persist_mode": "'$PERSIST_MODE'", "hanlon_static_path": "'$HANLON_STATIC_PATH'", "persist_host": "'$MONGO_PORT_27017_TCP_ADDR'", "ipmi_utility": "ipmitool", "ipmi_username": "'$IPMI_USER'", "ipmi_password": "'$IPMI_PASS'"}'
  fi
else
